  ...
  return (
    <div className='mt-20 pb-5'>
      <div className='text-4xl text-center font-semibold mb-3 text-mine-shaft-100'>
        How it <span className='text-kashmir-blue-400'>Works</span>
      </div>
      ...
      <div className='flex px-16 justify-between items-center'>
        <div className='relative'>
          ...
          <div className='w-36 flex top-[15%] right-0 absolute flex-col items-center gap-1 border border-kashmir-blue-400 rounded-xl py-3 px-1 backdrop-blur-md'>
        ...
        <div className='flex flex-col gap-10'>
          {work.map((item, index) => (
            <div key={index} className='flex items-center gap-4'>
              <div className='p-2.5 bg-kashmir-blue-300 rounded-full'>
                <img
                  className='w-12 h-12'
